...
with open("tests/test_data.txt", "r", encoding="utf-8") as test_data:
    ado_org, ado_project, email, pat_token, existing_repo_name, existing_repo_id = test_data.read().splitlines()
...
class TestBuild:
    ...
    def test_from_json(self):
        repo = Build.from_json({"requestedBy": {"displayName": "test", "uniqueName": "test", "id": "123"},
                                "repository": {"id": "123", "name": "test-repo"},
                                "id": "123", "buildNumber": "123", "status": "completed", "templateParameters": {}, "startTime": "2021-10-01T00:00:00Z", "finishTime": "2021-10-01T00:00:00Z", "queueTime": "2021-10-01T00:00:00Z", "reason": "manual", "priority": "normal"})
