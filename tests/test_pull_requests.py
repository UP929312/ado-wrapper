...
class TestPullRequest:
    ...
    def test_create_delete(self) -> None:
        repo = Repo.create(self.ado_client, "azuredevops-test-repo-for-create-delete-pull-request")
    ...
    def test_get_by_id(self) -> None:
        repo = Repo.create(self.ado_client, "azuredevops-test-repo-for-get-pull-request-by-id")
        Commit.create(self.ado_client, repo.repo_id, "main", "test-branch", {"test.txt": "Delete me!"}, "add", "Test commit")
    ...
    def test_mark_as_draft(self) -> None:
        repo = Repo.create(self.ado_client, "azuredevops-test-repo-for-mark-as-draft")
        Commit.create(self.ado_client, repo.repo_id, "main", "test-branch", {"test.txt": "Delete me!"}, "add", "Test commit")
    ...
    def test_update(self) -> None:
        repo = Repo.create(self.ado_client, "azuredevops-test-repo-for-update-pull-request")
        Commit.create(self.ado_client, repo.repo_id, "main", "test-branch", {"test.txt": "Delete me!"}, "add", "Test commit")
        pull_request = PullRequest.create(self.ado_client, repo.repo_id, "test-branch", "Test PR for Update", "Test PR description")
        # =====
        pull_request.update(self.ado_client, "title", "azuredevops-test-repo-for-update-pull-request-renamed")
        assert pull_request.title == "azuredevops-test-repo-for-update-pull-request-renamed"  # Test instance attribute is updated
        ...
        assert fetched_pull_request.title == "azuredevops-test-repo-for-update-pull-request-renamed"
