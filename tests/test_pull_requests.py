...
class TestPullRequest:
    ...
    def test_create_delete(self) -> None:
        repo = Repo.create(self.ado_client, "ado_wrapper-test-repo-for-create-delete-pull-request")
    ...
    def test_get_by_id(self) -> None:
        repo = Repo.create(self.ado_client, "ado_wrapper-test-repo-for-get-pull-request-by-id")
        Commit.create(self.ado_client, repo.repo_id, "main", "test-branch", {"test.txt": "Delete me!"}, "add", "Test commit")
    ...
    def test_update(self) -> None:
        repo = Repo.create(self.ado_client, "ado_wrapper-test-repo-for-update-pull-request")
        Commit.create(self.ado_client, repo.repo_id, "main", "test-branch", {"test.txt": "Delete me!"}, "add", "Test commit")
