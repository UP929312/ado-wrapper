...
class TestReleaseDefinition:
    ...
    def test_from_request_payload(self) -> None:
        ...
        assert release_definition.name == "test-repo"
    ...
    def test_create_delete(self) -> None:
        ...
        assert release_definition.description == f"Please contact {email} if you see this release definition!"
        release_definition.delete(self.ado_client)
    ...
    def test_get_all_by_definition_id(self) -> None:
        ...
        release_definitions = ReleaseDefinition.get_all_releases_for_definition(self.ado_client, release_definition.release_definition_id)
